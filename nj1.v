...
From Quantifiers Require Export foformulas_ext.
...
Hint Rewrite (@freevars_esubs_closed vatom tatom fatom Nocon Nocon Icon Qcon nat)
...
Lemma rpsubsz_r {l A x u} : closed u -> rprove l⇈ A↑[evar 0//x] -> rprove l (subs x u A).
Proof.
intros Hc pi.
...
- rewrite <- (app_nil_l _) in pi1.
  assert (pi1' := snd rweakening _ _ (snd (rnpesubs ⇑ closed_fup) pi1)
