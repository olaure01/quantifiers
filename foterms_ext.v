...
Lemma tvars_tesubs t : incl (tvars t) (tvars t⟦r⟧).
Proof. term_induction t.
rewrite <- 2 flat_map_concat_map.
intros x Hin.
apply in_flat_map in Hin as [ u [ Huin Hinu ] ].
...
Lemma no_tecapture_less lv1 lv2 t : incl lv1 lv2 ->
  #[[lv2]] t -> #[[lv1]] t.
Proof. term_induction t.
- intro. apply incl_Forall. assumption.
- apply Forall_fold_right in H0.
  apply Forall_fold_right, Forall_forall. intros u Hu.
  specialize_Forall_all u. auto.
Qed.

Lemma closed_no_tecapture : rclosed -> forall lv t, #[[lv]] t.
Proof. intros Hc. term_induction t.
- rewrite (Hc n). apply Forall_forall. auto.
...
Lemma multi_tsubs_tesubs : forall L t, rclosed ->
